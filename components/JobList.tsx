                ...
                return (
                    <div key={job.id} className="relative group">
                        ...
                        <button
                            ...
                            className="absolute top-1/2 -translate-y-1/2 -left-12 p-3 text-gray-500 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-all hover:scale-110 z-10"
